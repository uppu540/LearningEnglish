...
public class QuizTime2 extends AppCompatActivity {
    ...
    public void check(View view) {
        ...
        if(data.equalsIgnoreCase("There are 12 months in a year"))
        {
            mp = MediaPlayer.create(getApplicationContext(),R.raw.claps);
            mp.start();
            new AlertDialog.Builder(QuizTime2.this,R.style.MyAlertDialogStyle)
                    .setTitle("Congratulations!")
                    .setMessage("Press Next to Continue!")
                    .setPositiveButton("NEXT", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            // continue with delete
                            Intent in = new Intent(QuizTime2.this,QuizTime3.class);
                            startActivity(in);
                        }
                    })
        ...
        else
        {
            ...
            mp.start();
            new AlertDialog.Builder(QuizTime2.this,R.style.MyAlertDialogStyleNo)
                    .setTitle("OOPS!!")
