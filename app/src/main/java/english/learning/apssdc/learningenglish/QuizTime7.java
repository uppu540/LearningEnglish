...
public class QuizTime7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_time7);
    ...
    public void check(View view) {
        ...
        if(data.equalsIgnoreCase("Some people like to climb mountains"))
        {
            mp = MediaPlayer.create(getApplicationContext(),R.raw.claps);
            mp.start();
            new AlertDialog.Builder(QuizTime7.this,R.style.MyAlertDialogStyle)
                    .setTitle("Congratulations!")
                    .setMessage("Press Next to Continue!")
                    .setPositiveButton("NEXT", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent in = new Intent(QuizTime7.this,QuizTime8.class);
                            startActivity(in);
        ...
        else
        {
            ...
            mp.start();
            new AlertDialog.Builder(QuizTime7.this,R.style.MyAlertDialogStyleNo)
                    .setTitle("OOPS!!")
