...
public class QuizTime12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Quiz Time");
        setContentView(R.layout.activity_quiz_time12);
    ...
    public void check(View view) {
        ...
        if(data.equalsIgnoreCase("Monkeys like to eat fruits"))
        {
            mp = MediaPlayer.create(getApplicationContext(),R.raw.claps);
            mp.start();
            new AlertDialog.Builder(QuizTime12.this,R.style.MyAlertDialogStyle)
                    .setTitle("Congratulations!")
                    .setMessage("Press Next to Continue!")
                    .setPositiveButton("NEXT", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent in = new Intent(QuizTime12.this,WhatIsThis.class);
                            startActivity(in);
        ...
        else
        {
            ...
            mp.start();
            new AlertDialog.Builder(QuizTime12.this,R.style.MyAlertDialogStyleNo)
                    .setTitle("OOPS!!")
