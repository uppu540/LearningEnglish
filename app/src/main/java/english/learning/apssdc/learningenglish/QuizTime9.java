...
public class QuizTime9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_time9);
    ...
    public void check(View view) {
        ...
        if(data.equalsIgnoreCase("Run to home before the storm"))
        {
            mp = MediaPlayer.create(getApplicationContext(),R.raw.claps);
            mp.start();
            new AlertDialog.Builder(QuizTime9.this,R.style.MyAlertDialogStyle)
                    .setTitle("Congratulations!")
                    .setMessage("Press Next to Continue!")
                    .setPositiveButton("NEXT", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent in = new Intent(QuizTime9.this,QuizTime10.class);
                            startActivity(in);
        ...
        else
        {
            ...
            mp.start();
            new AlertDialog.Builder(QuizTime9.this,R.style.MyAlertDialogStyleNo)
                    .setTitle("OOPS!!")
