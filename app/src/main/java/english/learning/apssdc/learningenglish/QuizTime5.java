...
public class QuizTime5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_time5);
    ...
    public void check(View view) {
        ...
        if(data.equalsIgnoreCase("I like eating mangos in summer"))
        {
            mp = MediaPlayer.create(getApplicationContext(),R.raw.claps);
            mp.start();
            new AlertDialog.Builder(QuizTime5.this,R.style.MyAlertDialogStyle)
                    .setTitle("Congratulations!")
                    .setMessage("Press Next to Continue!")
                    .setPositiveButton("NEXT", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent in = new Intent(QuizTime5.this,QuizTime6.class);
                            startActivity(in);
        ...
        else
        {
            ...
            mp.start();
            new AlertDialog.Builder(QuizTime5.this,R.style.MyAlertDialogStyleNo)
                    .setTitle("OOPS!!")
