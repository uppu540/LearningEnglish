...
public class QuizTime3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_time3);
    ...
    public void check(View view) {
        ...
        if(data.equalsIgnoreCase("Raju is sleeping on the mat"))
        {
            mp = MediaPlayer.create(getApplicationContext(),R.raw.claps);
            mp.start();
            new AlertDialog.Builder(QuizTime3.this,R.style.MyAlertDialogStyle)
                    .setTitle("Congratulations!")
                    .setMessage("Press Next to Continue!")
                    .setPositiveButton("NEXT", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent in = new Intent(QuizTime3.this,QuizTime4.class);
                            startActivity(in);
                        }
                    })
        ...
        {
            mp = MediaPlayer.create(getApplicationContext(),R.style.MyAlertDialogStyleNo);
            mp.start();
            new AlertDialog.Builder(QuizTime3.this)
                    .setTitle("OOPS!!")
