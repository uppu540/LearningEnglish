...
public class BasicSplashunit3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_splash_unit3);
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                Intent i =new Intent(getApplicationContext(),iLike.class);
                startActivity(i);
            }
