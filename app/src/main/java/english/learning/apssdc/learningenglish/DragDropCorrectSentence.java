...
public class DragDropCorrectSentence extends AppCompatActivity {
    ...
    public void check(View view) {
        ...
        if(data.equalsIgnoreCase("Chacha's Birthday is on 14th November"))
        {
            mp = MediaPlayer.create(getApplicationContext(),R.raw.claps);
            mp.start();
            new AlertDialog.Builder(DragDropCorrectSentence.this,R.style.MyAlertDialogStyle)
                    ...
                    .setPositiveButton("NEXT", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent in = new Intent(getApplicationContext(),WhatIsThis.class);
                            startActivity(in);
                        }
                    })
        ...
        else
        {
            ...
            mp.start();
            new AlertDialog.Builder(DragDropCorrectSentence.this,R.style.MyAlertDialogStyleNo)
                    .setTitle("OOPS!!")
