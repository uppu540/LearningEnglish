...
public class QuizTime10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_time10);
    ...
    public void check(View view) {
        ...
        if(data.equalsIgnoreCase("The storm brings strong winds and heavy rain"))
        {
            mp = MediaPlayer.create(getApplicationContext(),R.raw.claps);
            mp.start();
            new AlertDialog.Builder(QuizTime10.this,R.style.MyAlertDialogStyle)
                    .setTitle("Congratulations!")
                    .setMessage("Press Next to Continue!")
                    .setPositiveButton("NEXT", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent in = new Intent(QuizTime10.this,QuizTime11.class);
                            startActivity(in);
        ...
        else
        {
            ...
            mp.start();
            new AlertDialog.Builder(QuizTime10.this,R.style.MyAlertDialogStyleNo)
                    .setTitle("OOPS!!")
